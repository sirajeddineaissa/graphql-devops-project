...
const Layout = ({ children, bg, ...props }) => {
  ...
  return (
    <Fragment>
      ...
      <CartButton onHandler={onMiniCartHandler} />

      <MobileNavbar isOpen={isShowMobileNav} onHandler={onMobileNavHandler} />

      <MiniCartSidebar isOpen={isShowMiniCart} onHandler={onMiniCartHandler} />
      ...
      <MobileFooter onMiniCartHandler={onMiniCartHandler} />
    </Fragment>
  );
};
